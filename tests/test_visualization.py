...
class TestMathVisualizer(unittest.TestCase):
    ...
    def test_plot_function_simple(self, mock_close: Any, mock_show: Any) -> None:
    ...
    @patch("matplotlib.pyplot.show")
    @patch("matplotlib.pyplot.close")
    def test_plot_function_trigonometric(self, mock_close: Any, mock_show: Any) -> None:
    ...
    def test_plot_function_invalid_expression(self) -> None:
    ...
    @patch("matplotlib.pyplot.show")
    @patch("matplotlib.pyplot.close")
    def test_plot_sequence(self, mock_close: Any, mock_show: Any) -> None:
    ...
    @patch("matplotlib.pyplot.show")
    @patch("matplotlib.pyplot.close")
    def test_plot_prime_distribution(self, mock_close: Any, mock_show: Any) -> None:
    ...
    @patch("matplotlib.pyplot.show")
    @patch("matplotlib.pyplot.close")
    def test_plot_collatz_trajectory(self, mock_close: Any, mock_show: Any) -> None:
    ...
    @patch("matplotlib.pyplot.show")
    @patch("matplotlib.pyplot.close")
    def test_plot_comparative_sequences(self, mock_close: Any, mock_show: Any) -> None:
        """Test plotting comparative sequences."""
        sequences = {
            "Fibonacci": [1.0, 1.0, 2.0, 3.0, 5.0],
            "Primes": [2.0, 3.0, 5.0, 7.0, 11.0],
        }
        result = self.visualizer.plot_comparative_sequences(
            sequences, title="Test Comparison"
        )
        self.assertTrue(result)
        mock_show.assert_called_once()
        mock_close.assert_called_once()
    ...
    @patch("matplotlib.pyplot.close")
    def test_plot_function_save_to_file(
        self, mock_close: Any, mock_savefig: Any
    ) -> None:
...
class TestVisualizationIntegration(unittest.TestCase):
    ...
    @patch("matplotlib.pyplot.show")
    @patch("matplotlib.pyplot.close")
    def test_fibonacci_sequence_visualization(
        self, mock_close: Any, mock_show: Any
    ) -> None:
    ...
    @patch("matplotlib.pyplot.show")
    @patch("matplotlib.pyplot.close")
    def test_prime_generation_visualization(
        self, mock_close: Any, mock_show: Any
    ) -> None:
