...
class SymbolicMath:
    ...
    @staticmethod
    def differentiate(
        expr: Union[str, sp.Expr], variable: Union[str, sp.Symbol], order: int = 1
    ) -> sp.Expr:
    ...
    def evaluate_expression(
        expr: Union[str, sp.Expr], substitutions: Optional[Dict[str, float]] = None
    ) -> Union[float, complex]:
...
class CalculusUtils:
    ...
    def find_critical_points(
        expr: Union[str, sp.Expr], variable: Union[str, sp.Symbol]
    ) -> List[sp.Expr]:
...
class AlgebraUtils:
    ...
    @staticmethod
    def solve_system(
        equations: List[Union[str, sp.Expr]], variables: List[Union[str, sp.Symbol]]
...
CONSTANTS = {"pi": pi, "e": E, "i": I, "infinity": oo, "oo": oo}

FUNCTIONS = {"sin": sin, "cos": cos, "tan": tan, "exp": exp, "log": log, "sqrt": sqrt}


__all__ = ["SymbolicMath", "CalculusUtils", "AlgebraUtils", "CONSTANTS", "FUNCTIONS"]
