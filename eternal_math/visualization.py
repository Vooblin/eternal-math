...
class MathVisualizer:
    ...
    def plot_function(
        ...
        try:
            ...
            if title:
                ...
                plt.title(
                    f"Plot of f(x) = {expression}", fontsize=14, fontweight="bold"
                )
    ...
    def plot_sequence(
        ...
        sequence: List[float],
        title: Optional[str] = None,
        x_labels: Optional[List[float]] = None,
        save_path: Optional[str] = None,
    ) -> bool:
        """
    ...
    def plot_prime_distribution(
        self, primes: List[int], limit: int, save_path: Optional[str] = None
    ) -> bool:
        """
        ...
        try:
            ...
            ax1.set_title(
                f"Prime Numbers up to {limit}", fontsize=14, fontweight="bold"
            )
            ...
            ax2.set_title(
                "Prime Counting Function π(x)", fontsize=14, fontweight="bold"
            )
    ...
    def plot_collatz_trajectory(
        ...
        try:
            ...
            plt.title(
                "Collatz Sequences (3n+1 Problem)", fontsize=14, fontweight="bold"
            )
            plt.grid(True, alpha=0.3)
            plt.legend()
    ...
    def plot_comparative_sequences(
        self,
        sequences_dict: Dict[str, List[float]],
        title: Optional[str] = None,
        save_path: Optional[str] = None,
    ) -> bool:
        """
